...
{skyphone} fetches the contributions data from the Skyline API and puts it in a nice, tidy table that you can sonify (i.e. convert to an audio signal) or plot. You can [read more in a  blog post](https://www.rostrum.blog/2021/02/21/skyphone/).
