...
You can hear the output if you set `play = TRUE` and/or save the audio file as a .wav to the folder provided by `out_dir`.  Here's what it sounds like:

<html><audio controls><source src="https://www.rostrum.blog/output/skyphone/skyphone_matt-dray_2020.wav" type="audio/wav"></audio></html>
